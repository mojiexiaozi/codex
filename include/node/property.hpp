...
{
public:
    FloatProperty(const uint &id, const std::string &name, PropertyType property_type) : Property(id, name, property_type)
    {
...
{
public:
    BoolProperty(const uint &id, const std::string &name, PropertyType property_type) : Property(id, name, property_type)
    {
...
{
public:
    StringProperty(const uint &id, const std::string &name, PropertyType property_type) : Property(id, name, property_type)
    {
...
{
public:
    ImageProperty(const uint &id, const std::string &name, PropertyType property_type) : Property(id, name, property_type)
    {
...
inline Property *create_property(const uint &id,
